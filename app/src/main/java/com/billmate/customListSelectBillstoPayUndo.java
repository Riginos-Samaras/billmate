...
public class customListSelectBillstoPayUndo extends ArrayAdapter<String>{
    ...
    public customListSelectBillstoPayUndo(Activity context,
        ...
        checkbox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(isChecked) {
                    ...
                    handler.updateBill(Integer.parseInt(idstring),false,12345);
